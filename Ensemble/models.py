...
#Slightly adapted (Adapted the padding, took out the checkpoints in training and the bilinear "upconvolution" option)
...
class UNet(nn.Module):
  ...
  def __init__(self, n_channels, n_classes):
    ...
    self.down1 = (Down(64, 128)) #  Downscaling with maxpool then double conv
    self.down2 = (Down(128, 256))
    self.down3 = (Down(256, 512))
    self.down4 = (Down(512, 1024 ))
    self.up1 = (Up(1024, 512)) #Upscaling then double conv
    self.up2 = (Up(512, 256))
    self.up3 = (Up(256, 128))
    self.up4 = (Up(128, 64))
...
#Source: Rodrigo Caye Daudt;https://rcdaudt.github.io/; Paper: Daudt, R. C., Le Saux, B., & Boulch, A. "Fully convolutional siamese networks for change detection". In 2018 25th IEEE International Conference on Image Processing (ICIP) (pp. 4063-4067). IEEE.
#not adapted (just used logits instead of softmax)
